...
* :mod:`ferro_ta.indicators.volume`          — Volume Indicators (AD, ADOSC, OBV, CMF, …)
* :mod:`ferro_ta.indicators.oscillators`     — Oscillators (AO, AC, KST, TSI, …)
* :mod:`ferro_ta.indicators.utils`           — Signal utilities (CROSSOVER, HIGHEST, …)
