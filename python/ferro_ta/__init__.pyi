...
def ULCER_INDEX(real: ArrayLike, timeperiod: int = 14) -> NDArray[np.float64]: ...
def STARC(
    high: ArrayLike,
    low: ArrayLike,
    close: ArrayLike,
...
def MEDIAN(real: ArrayLike, timeperiod: int = 3) -> NDArray[np.float64]: ...
def MEDIAN_BANDS(
    high: ArrayLike,
    low: ArrayLike,
    close: ArrayLike,
...
def MODE(
    real: ArrayLike, timeperiod: int = 20, bins: int = 10
) -> NDArray[np.float64]: ...
